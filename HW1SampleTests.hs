...
p1_test4 = TestCase (assertBool "exists 'C' \"CptS355\"" (exists 'C' "CptS355"))
p1_test5 = TestCase (assertBool "exists 't' \"CptS355\"" (exists 't' "CptS355"))
...
p2_test4 = TestCase (assertEqual "listUnion [1,1,4] [1,1,4,5]"  (sort [1,4,5])  (sort (listUnion [1,1,4] [1,1,4,5])) ) 
p2_test5 = TestCase (assertEqual "listUnion [1,1,1] [1,1,1,1]"  (sort [1])  (sort (listUnion [1,1,1] [1,1,1,1])) ) 
...
p3_test4 = TestCase (assertEqual "replace 2 'Y' \"frxs\""  "frYs" (replace 2 'Y' "frxs") )
p3_test5 = TestCase (assertEqual "replace 3 'l' \"helo\""  "hell" (replace 3 'l' "helo") )
...
p4_test5 = TestCase (assertEqual "prereqFor prereqsList \"CptS131\"" (sort ["CptS132"])  (prereqFor prereqsList "CptS131") )
...
p5_test4 = TestCase (assertBool "isPalindrome \"racecar\"" (isPalindrome "racecar"))
p5_test5 = TestCase (assertBool "isPalindrome \"aabbaa\"" (isPalindrome "aabbaa"))
...
p6_test5 = TestCase (assertEqual "groupSumtoN 20 []" [] (groupSumtoN 20 []) )  
